...
var options = {
    ...
    colors: ['#00ADEE', '#fcb92c', '#1cbb8c', '#ff3d60'],
    legend: {
        offsetY: 5
    }
...
var options = {
    ...
    colors: ["#1cbb8c", "#00ADEE", "#fcb92c", "#4aa3ff", "#ff3d60"],
    legend: {
        show: true,
        position: 'bottom',
