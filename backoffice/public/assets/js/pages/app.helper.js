	...
	var settings = {
	  ...
	  $.ajax(settings).done(function (response) {
		if (response) {
			...
			app_fields_data.vehicle_type=response.data.vehicle_type;
			app_fields_data.region=response.data.region;
			app_fields_data.departments_section=response.data.departments_section;
			app_fields_data.fuel_type=response.data.fuel_type;
		}
	  });
}
...
class FormAppHelper {
    ...
    static fillVehicleCIAOptions=function(record_id,form_select,optionSelected){
        return new Promise(function(resolve, reject){
            var settings = {
